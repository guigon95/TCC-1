...
Tendo em vista o interesse de alunos de Bacharelado em Engenharia, ligados à tecnologia da informação, como Engenharia de Computação, Engenharia Elétrica e Engeharia de Controle e Automação, em manter o contato com circuitos eletrônicos, e o engajamento causado por jogos no ensino, intensificando os conceitos adquiridos na teoria de forma prática  [El-Shamy 2008], este trabalho tem por finalidade utilizar a plataforma arduino como motivação para introduzir boas práticas em engenharia de software através de um jogo educativo.
