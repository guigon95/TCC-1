...
Para \citeonline{McGonigal2011}, um jogo deve conter quatro traços definidores: uma meta, regras, um sistema de \textit{feedback} e participação voluntária. A meta dá um senso de propósito. As regras são essenciais para desencadear a criatividade e promover um pensamento estratégico. O \textit{feedback} propicia a motivação. A participação voluntária torna a experiência segura e prazerosa.
